...
public class DemoActivity extends Activity implements ScanditSDKListener {
    ...
    public static final String sScanditSdkAppKey = "/pWzMKR7EeOcSFMYppVNe0FIaUh/o0VB2Kj+Qt6cY6c";
    ...
    public void didScanBarcode(String barcode, String symbology) {
        ...
        for (int i = 0 ; i < barcode.length(); i++) {
           ...
           // String K ="http://www.youtube.com/watch?v=aqvbnNZdexU"; 
           
            }
        
    //System.out.println(cleanedBarcode);
    //String K = cleanedBarcode;
    String J = "http://www.youtube.com/watch?v=aqvbnNZdexU";
    String I ="http://www.youtube.com/watch?v=RbO7VIStoew";
    //if(J.equals(cleanedBarcode)){
    if(cleanedBarcode.equals(J)){
    ...
    else if(cleanedBarcode.equals(I)){
    ...
    else{Toast.makeText(this, "not recognised Alchemy Video", Toast.LENGTH_LONG).show();}
     ...
     //Toast.makeText(this, symbology + ":" + cleanedBarcode, Toast.LENGTH_LONG).show();
		...
		//if(J == (cleanedBarcode += barcode.charAt(i))){
        	
			//Intent i = new Intent(getApplicationContext(),Availability.class);
			//startActivity(i);
        
      //  }
	//	else{ Toast.makeText(this,cleanedBarcode, Toast.LENGTH_LONG).show();}
		
		//if(){}
		
       // else{ Toast.makeText(this, symbology + ": " + cleanedBarcode, Toast.LENGTH_LONG).show();}
    }
